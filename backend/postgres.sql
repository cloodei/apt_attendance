ALTER TABLE "STUDENT_LIST" DROP CONSTRAINT IF EXISTS "student_list_class_id_foreign";
ALTER TABLE "STUDENT_LIST" DROP CONSTRAINT IF EXISTS "student_list_student_id_foreign";
ALTER TABLE "CLASSES" DROP CONSTRAINT IF EXISTS "classes_user_id_foreign";
ALTER TABLE "SESSIONS" DROP CONSTRAINT IF EXISTS "sessions_class_id_foreign";
ALTER TABLE "STUDENT_IDENTITIES" DROP CONSTRAINT IF EXISTS "vectors_student_id_foreign";
ALTER TABLE "ATTENDANCES" DROP CONSTRAINT IF EXISTS "attendances_session_id_foreign";

DROP TABLE IF EXISTS "STUDENTS" CASCADE;
DROP TABLE IF EXISTS "STUDENT_LIST" CASCADE;
DROP TABLE IF EXISTS "CLASSES" CASCADE;
DROP TABLE IF EXISTS "USERS" CASCADE;
DROP TABLE IF EXISTS "SESSIONS" CASCADE;
DROP TABLE IF EXISTS "STUDENT_IDENTITIES" CASCADE;
